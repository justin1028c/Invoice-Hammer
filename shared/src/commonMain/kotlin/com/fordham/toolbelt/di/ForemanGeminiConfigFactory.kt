...
fun createDefaultForemanGeminiConfig(secretProvider: SecretProvider): ForemanGeminiConfig {
    ...
    val agentModelName = secretProvider.getSecret("gemini_agent_model_name").takeIf { it.isNotBlank() } ?: "gemini-1.5-flash"
    val taskModelName = secretProvider.getSecret("gemini_task_model_name").takeIf { it.isNotBlank() } ?: "gemini-1.5-flash"
