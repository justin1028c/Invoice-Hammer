        ...
        matching { it.name in listOf("kotlinMultiplatform", "androidRelease", "iosArm64", "iosX64", "iosSimulatorArm64") }
            .all {
                ...
                publication.pom {
                    ...
                    url.set("https://gitlab.com/Justin1028c/secure-vault")
                    licenses {
                        license {
                    ...
                    scm {
                        connection.set("scm:git:git://gitlab.com/Justin1028c/secure-vault.git")
                        developerConnection.set("scm:git:ssh://gitlab.com/Justin1028c/secure-vault.git")
                        url.set("https://gitlab.com/Justin1028c/secure-vault")
                    }
                }
            }
